...
class Chef
  class Resource
    # A resource used to manages the LDAP Connection used by Security Realm
    # controlling access to the JBoss Console using an LDAP directory.
    #
    # @provides :ldap_connection
    # @action create
    # @action remove
    #
    class JBossLDAPConnection < Chef::Resource
      include JBoss
  ...
  class Provider
    class JBossLDAPConnection < Chef::Provider
      include JBoss
